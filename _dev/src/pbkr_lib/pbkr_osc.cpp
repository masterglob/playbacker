        ...
        mActiveTrack(-1)
{
    ...
    std::cout << "Bound OSC listen port to "<< (unsigned)(m_cfg.portIn) << std::endl;
...
{
    cout << "key=" << key << endl;
    if (key == "menuCancel")     globalMenuInstance().pressKey( PBKR::MainMenu::KEY_CANCEL);
    else if (key == "menuOk")    globalMenuInstance().pressKey( PBKR::MainMenu::KEY_OK);
    else if (key == "menuLeft")  globalMenuInstance().pressKey( PBKR::MainMenu::KEY_LEFT);
    else if (key == "menuRight") globalMenuInstance().pressKey( PBKR::MainMenu::KEY_RIGHT);
    else if (key == "menuDown")  globalMenuInstance().pressKey( PBKR::MainMenu::KEY_DOWN);
    else if (key == "menuUp")    globalMenuInstance().pressKey( PBKR::MainMenu::KEY_UP);
