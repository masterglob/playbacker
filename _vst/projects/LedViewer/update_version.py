...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright CMM_Studios, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/LedViewer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LedViewer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LedViewer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LedViewer-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LedViewer-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LedViewer-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/LedViewer-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/LedViewer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/LedViewer.iss",inplace=1):
