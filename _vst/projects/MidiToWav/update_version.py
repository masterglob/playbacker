...
def main():
  ...
  plistpath = scriptpath + "/resources/MidiToWav-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiToWav-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiToWav-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiToWav-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiToWav-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiToWav-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MidiToWav-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MidiToWav.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MidiToWav.iss",inplace=1):
